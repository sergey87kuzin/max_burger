...
async def test_admin_objects(
    ...
    response = client.post(f"api/admin/{url}/", content=json.dumps(data_dict), headers=headers)
    ...
    single_response = client.get(url=f"api/admin/{url}/{object_from_db_id}/", headers=headers)
    ...
    list_response = client.get(url=f"api/admin/{url}/list/", headers=headers)
    ...
    delete_response = client.delete(url=f"api/admin/{url}/{object_from_db_id}/", headers=headers)
